  ...
  return [
    {
      ...
      link: "https://flashy-dahlia-c75.notion.site/ref-reactive-86f06676493743128a5124e5c4a13b56?pvs=4",
...
console.log(map.get(&#x27;count&#x27;).value)</code></pre></div></article><span class="sans" style="font-size:14px;padding-top:2em"></span>`,
    },
    {
      type: "JavaScript",
      title: "變數與作用域",
      link: "https://flashy-dahlia-c75.notion.site/ad04b2ad6ced484d84054af5b2024972?pvs=4",
...
//result = (a !== null &amp;&amp; a !== undefined) ? a : b;</code></pre><p id="9d72b698-030e-436a-91bb-d024db7276b8" class="">
    ...
    },
    {
      type: "Nuxt",
      title: "Nuxt Seo 設定",
      link: "https://flashy-dahlia-c75.notion.site/SEO-and-Meta-b8faf8e514ae408484ce1b75e546e586?pvs=4",
...
&lt;/script&gt;</code></pre><p id="1a2b6c58-18fd-4ad3-8faa-56b069368d55" class="">
    ...
    },
    {
      type: "Vue",
      title: "Vue Router",
      link: "https://flashy-dahlia-c75.notion.site/Vue-Router-7f4f598afaa249a68818af94c9e42dec?pvs=4",
...
const routes = [
...
]</code></pre><p id="32d57ede-c3b1-4498-8090-635800850429" class="">混用</p><pre id="84035060-e77e-4943-a28e-16dc85086f9e" class="code"><code>const routes = [
  {
    ...
    },
    {
      type: "Vue",
      title: "Pinia",
      link: "https://flashy-dahlia-c75.notion.site/Pinia-2df952930666478a8b4c4edd80731751?pvs=4",
...
console.log(store.$global.id) // &#x27;globalStore&#x27;</code></pre></div></details></div></article><span class="sans" style="font-size:14px;padding-top:2em"></span>`,
    },
    {
      type: "Other",
      title: "快速上手 Git",
      link: "https://flashy-dahlia-c75.notion.site/Git-learn-0e1f7c1f1b4442ef8c0b777c237ef3fb?pvs=4",
      article: "",
    },
    {
      type: "JavaScript",
      title: "TypeScript 基礎",
      link: "https://flashy-dahlia-c75.notion.site/TypeScript-defe646b43b040fd8ba974c844a93c2a?pvs=4",
      article: "",
    },
  ];
});
